...
| Page | Description |
|---|---|
| `index.html` | Homepage — hero section, featured dishes, "why choose us," call-to-action |
| `menu.html` | Full menu with category tabs (Starters, Tandoor, Mains, Desserts, Drinks) and search bar |
| `cart.html` | Cart/checkout page — order summary receipt and delivery details form (static demo) |
